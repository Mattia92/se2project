...
\usepackage[right=3.0cm,left=3.0cm,top=3.5cm,bottom=3.5cm]{geometry}
...
\input{cpt/IntegrationStrategy.tex}
\clearpage

\input{cpt/IndividualStepsTestDescription.tex}
\clearpage

\input{cpt/ToolsTestEquipmentRequired.tex}
\clearpage

\input{cpt/ProgramStubsTestDataRequired.tex}
\clearpage
