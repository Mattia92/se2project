...
\Large
\begin{center}
\begin{tabular}{p{0.65\textwidth}p{0.6\textwidth}}
& Autori: \\
...
\input{cpt/ActorsIdentyfing.tex}
\clearpage

\input{cpt/SpecificRequirements.tex}
\clearpage

\input{cpt/ScenarioIdentifying.tex}
\clearpage

\input{cpt/UMLModels.tex}
\clearpage

\input{cpt/AlloyModelling.tex}
\clearpage

\input{cpt/UsedTools.tex}
\clearpage
